...
public interface ListEx<E> extends List<E>, HasListExEvents<E> {
	...
	/**
	 * Returning read-only view of this list which will containing only those
	 * items which considered as suitable by filterPredicate
	 * 
	 * @param filterPredicate
	 *            predicate which decide if list item is suitable for new view
	 *            or not
