...
public class ModelMultSelInListBinding<E> implements Binding, ListSelectionListener, ListExEventListener<E> {
	...
	public ModelMultSelInListBinding(BindingContext bindingContext, ModelMultSelInListPropertyAccessor<E> modelProperty,
			JList list) {
	...
	public void valueChanged(ListSelectionEvent arg0) {
		...
		skipEventsFromList = true;
		try {
			modelProperty.setNewSelection(list.getSelectedValues());
		} finally {
			skipEventsFromList = false;
		}
	}
